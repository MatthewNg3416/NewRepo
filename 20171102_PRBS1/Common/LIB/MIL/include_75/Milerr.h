...
#define M_ERR_5_SUBMSG_1         MIL_TEXT("Cannot unlock a not locked mutex.")
#define M_ERR_5_SUBMSG_2         MIL_TEXT("Cannot free a mutex still locked.")
...
#define M_ERR_74_SUBMSG_8        MIL_TEXT("No slave function in the internal functions table")
...
#define M_ERR_98_SUBMSG_2        MIL_TEXT("One of the ID in the list is not a valid event.")
#define M_ERR_98_SUBMSG_3        MIL_TEXT("All events don't belong to the same system type.")
