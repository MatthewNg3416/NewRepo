...
#ifdef CML_ERROR_MESSAGES
#  define CML_NEW_ERROR( group, name, message ) const group group::name = group( CMLERR_ ## group ## _ ## name, message )
#else
#  define CML_NEW_ERROR( group, name, message ) const group group::name = group( CMLERR_ ## group ## _ ## name, 0 )
#endif
