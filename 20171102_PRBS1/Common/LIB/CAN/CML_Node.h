...
protected:
   ...
   /// Delay to use when changing modes.  This is here as a work around for
   /// Beckhoff I/O modules which don't conform to the CANopen spec very well.
   int32 stateChangeDelay;
