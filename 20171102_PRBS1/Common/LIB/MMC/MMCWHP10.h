...
INT	API motion_fpga_version_chk( INT, pINT);
INT API option_fpga_version_chk( INT, pINT);
...
INT API set_mpg_velocity(INT mpg_vel);
INT API get_mpg_velocity(INT *mpg_vel);
INT API set_mpg_enable(INT ax,INT state);
INT API get_mpg_enable(INT ax,INT *state);
