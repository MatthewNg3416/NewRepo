...
CTBalloon::CTBalloon(UINT nWidth, UINT nHeight, CString s): m_nWidth(nWidth), m_nHeight(nHeight)
{	
...
BOOL CTBalloon::CreateAndShow()
{
	...
	const WCHAR * p = AfxRegisterWndClass(CS_HREDRAW | CS_VREDRAW );
...
void CTBalloon::OnPaint() 
{
	...
	CFont font;
	VERIFY(font.CreateFont(12, 0, 0, 0,	FW_NORMAL,
