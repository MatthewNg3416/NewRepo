...
/**
 * MSercosAxis.h : This file defines the class of single-axis and multi-axis.
...
#ifndef MSercosAxis_H
#define MSercosAxis_H
 ...
 * @version $Revision$
 */
class MSercosAxis : public IAxis
{
...
public:		// Constructor & Destructor
	 ...
	 * @stereotype constructor
	 */
	MSercosAxis(SCommonAttribute commonData, SSMotionData datComponent, IIO* pIO, ISercosSetup* pSercosSetup);    
