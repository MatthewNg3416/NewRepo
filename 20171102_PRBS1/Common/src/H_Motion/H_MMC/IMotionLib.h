...
/**
 * IMotionLib.h : This file defines the interface class of Motion libraries.
...
public:
	 ...
	 */
	virtual int SetUseAxis(short siAxisID, BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetUseAxis(short siAxisID, BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetMotorParam(short siAxisID, SMotionAxis mAx, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetMotorParam(short siAxisID, SMotionAxis *pmAx) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetBoardParam(SMotionBoard MotionBd) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetBoardParam(SMotionBoard *pmBd) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetBoardNum(short *psiBdNum) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int Initialize(short siBdNum, long *plAddress) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetBoardInit(BOOL *pbInit) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAxes(short siBdNum, short *psiAxes) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int MapAxes(short siAxNum, short *psiMapArray) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int Dwell(short siAxis, long *plDuration) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int IOTrigger(short siAxis, short siBitNo, BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int InCommand(short siAxis, short siType) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int AllDone(BOOL *pbStatus) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int WaitDone(short siAxis, short siMode) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int WaitForDone(short siAxis, short *psiAxis = NULL) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpFaultEnable(short siAxis, BOOL bState) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int GetAllStatus(short siAxis, short *psiStatus, long *plStatus, double *pdStatus) = 0;
	 ...
	 * @return	Puls
	 */
	virtual int GetComVelocity(short sAxis) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int GetAxisSource(short siAxis, short *psiState) = 0;
	 ...
	 */
	virtual int GetSensorStatus(short siAxis, short siType, BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpEnable(short siAxis, BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpEnableLevel(short siAxis, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int GetAxisLatchStatus(short siBdNum, BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int ClearStatus(short siAxis) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int ClearFrames(short siAxis) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int FramesInterpolation(short siAxis, short *psiFrameNo) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int FramesLeft(short siAxis, short *psiFrameNo) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int Latch(short siBdNum, BOOL bType, BOOL bState = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetLatchedPosition(short siAxis, double *pdPosition) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int CompensationPos(short siLen, short *psiAxes, double *pdDist, short *psiAccel) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetDpramAddress(short siBdNum, long *plAddr) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAbsEncoderType(short siAxis, short *psiType) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetVelLimit(short siAxis, double *pdVelocity, short *psiAccel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  xx = INVALID POINTER(MOTIONLIB)
	 */
	virtual int GetAmpFaultStatus(short siAxis, BOOL *pbStatus) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpFaultEvent(short siAxis, short *psiAction, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpEanbleLevel(short siAxis, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpFaultLevel(short siAxis, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpResetLevel(short siAxis, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAmpResolution(short siAxis, short *psiResolution, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetEncoderRatio(short siAxis, short *psiRatioA, short *psiRatioB, BOOL bBootOpt= FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetEndlessAx(short siAxis, BOOL *pbStatus, BOOL bType, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetEndlessRange(short siAxis, double *pdRange, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetInPosition(short siAxis, double *pdInPosition, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetInpositionRequired(short siAxis, BOOL *pbReq, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetErrorLimit(short siAxis, double *pdLimit, short *psiAction, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetIndexRequired(short siAxis, BOOL *pbIndexReq, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetIOMode(short siBdNum, BOOL *pbMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSensorLimit(short siAxis, short siType, short *psiLimit, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSensorEvent(short siAxis, short siType, short *psiLimit, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSensorLevel(short siAxis, short siType, BOOL *pbLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSWLimit(short siAxis, BOOL bType, double *pdPosition, short *psiLimit, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetMotorType(short siAxis, short *psiType, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAxisProperty(short siAxis, short *psiDevice, BOOL *pbLoop, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetRatioProperty(short siAxis, short *psiPgratio, double *pdEgratio, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetVServoProperty(short siAxis, BOOL *pbControl, BOOL *pbPolar, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetStepMode(short siAxis, BOOL *pbMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetEncoderDirection(short siAxis, BOOL *pbEncDir, BOOL *pbCoorDir, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetStopRate(short siAxis, BOOL bType, short *psiRate, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSyncGain(long *plCoeff) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetGain(short siAxis, BOOL bVelType, long *plGain, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetIntegration(short siAxis, BOOL bType, BOOL *pbMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetVelocity(short siAxis, BOOL bType, short *psiPulse) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAxisRunStop(short siBdNum, short *psiState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetPosition(short siAxis, BOOL bCommandType, double *pdPosition) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetRpm(short siAxis, BOOL bType, short *psiRpm) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetControlTimer(short siBdNum, short *psiTime, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetError(short siAxis, double *pdError) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetFastReadEncoder(short siAxis, BOOL *pbStatus) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAnalogOffset(short siAxis, short *psiOffset, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetIO(short siPort, BOOL bType, long *plValue) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetAnalog(short siChannel, BOOL bType, short *psiValue) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetCollisionPreventFlag(short siBdNum, BOOL *pbMode) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSyncControl(BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSyncPosition(double *pdMasterPos, double *pdSlavePos) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int IOInterrupt(short siID, short siType, BOOL bState, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int IOInterruptPCIRQ(short siBdNum, BOOL bState, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int IOInterruptPCIRQ_EOI(short siBdNum) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetController(short siAxis, BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpEnable(short siAxis, BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetVelLimit(short siAxis, double dVelocity, short siAccel) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpFaultEvent(short siAxis, short siAction, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpEnableLevel(short siAxis, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpFaultLevel(short siAxis, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpResetLevel(short siAxis, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAmpResolution(short siAxis, short siResolution, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetEncoderRatio(short siAxis, short siRatioA, short siRatioB, BOOL bBootOpt= FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetEndlessRange(short siAxis, double dRange, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetIndexRequired(short siAxis, BOOL bIndexReq, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetMotorType(short siAxis, short siType, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAxisProperty(short siAxis, short siDevice, BOOL bLoop, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetRatioProperty(short siAxis, short siPgratio, double dEgratio, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetVServoProperty(short siAxis, BOOL bControl, BOOL bPolar, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetStepMode(short siAxis, BOOL bMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetEncoderDirection(short siAxis, BOOL bEncDir, BOOL bCoorDir, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetIOMode(short siBdNum, BOOL bMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetInPosition(short siAxis, double dInPosition, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetInpositionRequired(short siAxis, BOOL bReq, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetErrorLimit(short siAxis, double dLimit, short siAction, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetStopRate(short siAxis, BOOL bType, short siRate, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSensorLimit(short siAxis, short siType, short siLimit, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSensorEvent(short siAxis, short siType, short siLimit, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSensorLevel(short siAxis, short siType, BOOL bLevel, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSWLimit(short siAxis, BOOL bType, double dPosition, short siLimit, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetGain(short siAxis, BOOL bVelType, long *plGain, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetIntegration(short siAxis, BOOL bType, BOOL bMode, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAxisRunStop(short siBdNum, short siState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetBit(short siBitNo, BOOL bValue) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetIO(short siPort, long lValue) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetDacOut(short siAxis, short siValue) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAnalogOffset(short siAxis, short siOffset, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAnalogLimit(short siAxis, short siLimit, BOOL bBootOpt= FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetPosition(short siAxis, BOOL bType, double dPosition) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetFastReadEncoder(short siAxis, BOOL bStatus) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetInterpolation(short siLen, short *psiAxes, long *plDelt, short siFlag) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetCollisionPreventFlag(short siBdNum, BOOL bMode) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetDpramAddress(short siBdNum, long lAddr) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAbsEncoderType(short siAxis, short siType) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetAbsEncoder(short siAxis) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetServoLinearFlag(short siAxis, short siFlag, BOOL bBootOpt= FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSyncControl(BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSyncMapAxes(short siMasterAx, short siSlaveAx) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSyncGain(short siCoeff, BOOL bBootOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetControlTimer(short siBdNum, short siTime, BOOL bBootOpt = FALSE) = 0;
...
//#endif
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetMoveSpeed(double dVelocity, short siAccel) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetSplAutoOff(short siBdNum, BOOL bState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int GetSplAutoOff(short siBdNum, BOOL *pbState) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetStop(short siAxis, short siType) = 0;
	...
	virtual int Move(short siAxis, double dPosition, double dVelocity, short siAccel,
					   short siDecel, short siType, BOOL bWaitOpt = FALSE) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int MoveN(short siLen, double *pdPosition, short siType) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int VMove(short siAxis, double dVelocity, short siAccel) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SplLineMoveN(short siAxNum, double *pdPoint, double dVelocity, short siAccel) = 0;
	 ...
	 */
	virtual int SplLineMoveNax(short siLen, short *psiAxes, double *pdPoint, double dVelocity, short siAccel) = 0;
	 ...
	 * @return	Error Code		: 0 = SUCCESS, 그 외 = Error
	 */
	virtual int SplAutoLineMoveNax(short siLen, short *psiAxes, double *pdPoint, double dVelocity, short siAccel, BOOL bAutoFlag) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SetArcDivision(double dDegree) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int Arc2(double dXCenter, double dYCenter, double dAngle) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int SplMovex(short siSplNum, short siAxis1, short siAxis2, short siAxis3) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int VersionCheck(short siBdNum, short *psiVersion) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int ErrorMessage(short siCode, char *pcDst) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int PositionCompareInit(short siIndexSel, short siAxis1, short siAxis2) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int PositionCompareEnable(short siBdNum, BOOL bFlag) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int PositionCompareClear(short siBdNum, short siIndexSel) = 0;
	 ...
	 *							  그 외 = 타 함수 Return Error
	 */
	virtual int PositionCompareRead(short siIndexSel, short siAxis, double *pdPosition) = 0;
