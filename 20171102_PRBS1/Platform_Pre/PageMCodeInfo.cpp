// PageMCodeInfo.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPageMCodeInfo property page

IMPLEMENT_DYNCREATE(CPageMCodeInfo, CPropertyPage)

CPageMCodeInfo::CPageMCodeInfo() : CPropertyPage(CPageMCodeInfo::IDD)
{
	//{{AFX_DATA_INIT(CPageMCodeInfo)
...
CPageMCodeInfo::~CPageMCodeInfo()
{
}

void CPageMCodeInfo::SetAutoMainWnd(HWND hMainView)
{
	m_hAutoMainWnd = hMainView;
}

void CPageMCodeInfo::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPageMCodeInfo)
...
BEGIN_MESSAGE_MAP(CPageMCodeInfo, CPropertyPage)
	//{{AFX_MSG_MAP(CPageMCodeInfo)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPageMCodeInfo message handlers

BOOL CPageMCodeInfo::OnInitDialog() 
{
...
BOOL CPageMCodeInfo::OnKillActive() 
{
...
BOOL CPageMCodeInfo::OnSetActive() 
{
	// TODO: Add your specialized code here and/or call the base class
	CPropertySheet* pParent = (CPropertySheet*)this->GetParent();
    if (pParent)
...
BEGIN_EVENTSINK_MAP(CPageMCodeInfo, CPropertyPage)
    //{{AFX_EVENTSINK_MAP(CPageMCodeInfo)
	ON_EVENT(CPageMCodeInfo, IDB_REQUEST_S_CURRENT, -600 /* Click */, OnClickRequestSCurrent, VTS_NONE)
	ON_EVENT(CPageMCodeInfo, IDB_REQUEST_G_CURRENT, -600 /* Click */, OnClickRequestGCurrent, VTS_NONE)
	ON_EVENT(CPageMCodeInfo, IDB_REQUEST_S_NEXT, -600 /* Click */, OnClickRequestSNext, VTS_NONE)
	ON_EVENT(CPageMCodeInfo, IDB_REQUEST_G_NEXT, -600 /* Click */, OnClickRequestGNext, VTS_NONE)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CPageMCodeInfo::clearDisplay()
{
	int i = 0, j = 0, k = 0;
...
void CPageMCodeInfo::updateDisplay()
{	
	MMaterialCodeInfo* pMatCodeInfo[DEF_MAX_PRODUCT_PLAN][DEF_MAX_TABFEEDER] =
	{
		{	&m_plnkLCNet->m_CurMaterialCodeInfo_S,	&m_plnkLCNet->m_CurMaterialCodeInfo_G	},
		{	&m_plnkLCNet->m_NextMaterialCodeInfo_S,	&m_plnkLCNet->m_NextMaterialCodeInfo_G	},
		{	&m_plnkLCNet->m_EndMaterialCodeInfo_S,	&m_plnkLCNet->m_EndMaterialCodeInfo_G	}
	};
...
void CPageMCodeInfo::RenewMaterialCode()
{
	clearDisplay();
	updateDisplay();
}

void CPageMCodeInfo::OnClickRequestSCurrent() 
{
	// TODO: Add your control notification handler code here
	materialCodeInfoRequest(DEF_CUR_PRODUCT_PLAN, eMatStep_S);
}

void CPageMCodeInfo::OnClickRequestGCurrent() 
{
	// TODO: Add your control notification handler code here
	materialCodeInfoRequest(DEF_CUR_PRODUCT_PLAN, eMatStep_G);
}

void CPageMCodeInfo::OnClickRequestSNext()
{
	// TODO: Add your control notification handler code here
	materialCodeInfoRequest(DEF_NEXT_PRODUCT_PLAN, eMatStep_S);
}

void CPageMCodeInfo::OnClickRequestGNext() 
{
	// TODO: Add your control notification handler code here
	materialCodeInfoRequest(DEF_NEXT_PRODUCT_PLAN, eMatStep_G);
}

void CPageMCodeInfo::materialCodeInfoRequest(int iPlanType, EMaterialStep eStep)
{
